...
GHAPI=https://api.github.com/repos/chaudhryfaisal/st/releases/latest 
VERSION=${1:-latest}
if [[ "$VERSION" != "latest" ]]; then
    GHAPI=https://api.github.com/repos/chaudhryfaisal/st/releases/tags/${VERSION}
...
if [[ -z $BINURL ]]; then
    ...
    echo "https://github.com/chaudhryfaisal/st/releases"
    exit 1
fi
...
wget -O /etc/systemd/system/cloud-torrent.service https://raw.githubusercontent.com/chaudhryfaisal/st/master/scripts/cloud-torrent.service
...
Read the wiki page about changing the default settings.
    https://github.com/chaudhryfaisal/st/wiki/AuthSecurity
